...
from utils.utils import board_to_fen
...
class Metrics:
    def __init__(self, model_name='', search_tree=False, tree_depth=None, tree_width=None):
    ...
    #         }
    #         general_summary['tree_statistics'] = tree_statistics
    #
    #     summary_path = os.path.join(self.plot_dir, 'game_summary.json')
    #     with open(summary_path, 'w') as f:
